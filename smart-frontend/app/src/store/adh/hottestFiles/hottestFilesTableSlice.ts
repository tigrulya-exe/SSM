...
type AdhFilesTableState = TableState<AdhFileInfoFilter>;

const createInitialState = (): AdhFilesTableState => ({
  filter: {
    lastAccessedTime: 'now-1h',
    pathLike: undefined,
  },
  paginationParams: {
    perPage: 10,
...
const filesTableSlice = createTableSlice({
  name: 'adh/cluster/filesTable',
  createInitialState,
  reducers: {},
  extraReducers: () => {},
});
