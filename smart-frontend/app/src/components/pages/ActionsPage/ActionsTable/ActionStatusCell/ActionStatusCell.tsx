...
const actionStateToStatus: Record<AdhActionState, CommonStatus> = {
...
const ActionStatusCell: React.FC<ActionStatusCellProps> = ({ action }) => {
  return (
    <TableCell data-qa="state">
      <FlexGroup gap="6px">
        <StatusMarker status={actionStateToStatus[action.state]} />
