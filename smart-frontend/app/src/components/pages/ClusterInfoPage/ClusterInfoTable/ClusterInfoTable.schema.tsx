...
export const clusterNodesColumns: TableColumnSchema[] = [
  {
    name: 'id',
    label: 'ID',
    isSortable: true,
  },
  {
    ...
    filterRenderer: (closeFilter) => {
      return (
        <TableDateRangePickerFilter<AdhClusterNodesFilter> filterName="registrationTime" closeFilter={closeFilter} />
      );
    },
    filterName: 'registrationTime',
    schema: {
