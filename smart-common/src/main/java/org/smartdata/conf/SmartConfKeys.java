...
public class SmartConfKeys {
    ...
    public static final String SMART_NAMESPACE_FETCHER_IGNORE_UNSUCCESSIVE_INOTIFY_EVENT_KEY = "smart.namespace.fetcher.ignore.unsuccessive.inotify.event";
    public static final boolean SMART_NAMESPACE_FETCHER_IGNORE_UNSUCCESSIVE_INOTIFY_EVENT_DEFAULT = false;
    public static final String SMART_NAMESPACE_FETCHER_PRODUCERS_NUM_KEY = "smart.namespace.fetcher.producers.num";
    public static final int SMART_NAMESPACE_FETCHER_PRODUCERS_NUM_DEFAULT = 3;
    public static final String SMART_NAMESPACE_FETCHER_CONSUMERS_NUM_KEY = "smart.namespace.fetcher.consumers.num";
    ...
    public static final String SMART_SERVER_KERBEROS_PRINCIPAL_KEY = "smart.server.kerberos.principal";
    public static final String SMART_AGENT_KEYTAB_FILE_KEY = "smart.agent.keytab.file";
    public static final String SMART_AGENT_KERBEROS_PRINCIPAL_KEY = "smart.agent.kerberos.principal";
    public static final String SMART_SECURITY_CLIENT_PROTOCOL_ACL = "smart.security.client.protocol.acl";
    public static final String SMART_SECURITY_ADMIN_PROTOCOL_ACL = "smart.security.admin.protocol.acl";
    ...
    public static final String SMART_METASTORE_CHARACTER_TAKEUP_BYTES_KEY = "smart.metastore.character.takeup.bytes";
    public static final int SMART_METASTORE_CHARACTER_TAKEUP_BYTES_DEFAULT = 1;

    public static final String SMART_METASTORE_MIGRATION_CHANGELOG_PATH_KEY = "smart.metastore.migration.liquibase.changelog.path";
    public static final String SMART_METASTORE_MIGRATION_CHANGELOG_PATH_DEFAULT = "db/changelog/changelog-root.xml";
    public static final String SMART_METASTORE_LEGACY_MYSQL_SUPPORT_KEY = "smart.metastore.mysql.legacy.enabled";
    public static final boolean SMART_METASTORE_LEGACY_MYSQL_SUPPORT_DEFAULT = false;

    public static final String SMART_ACCESS_COUNT_AGGREGATION_INTERVAL_MS = "smart.access.count.aggregation.interval.ms";
    public static final int SMART_ACCESS_COUNT_AGGREGATION_INTERVAL_MS_DEFAULT = 5000;

    public static final String SMART_ACCESS_COUNT_AGGREGATOR_FAILOVER_KEY = "smart.access.count.aggregator.failover";

    public static final String SMART_NUM_DAY_TABLES_TO_KEEP_KEY = "smart.access.count.day.tables.num";
    public static final int SMART_NUM_DAY_TABLES_TO_KEEP_DEFAULT = 30;

    public static final String SMART_NUM_HOUR_TABLES_TO_KEEP_KEY = "smart.access.count.hour.tables.num";
    ...
    public static final String SMART_NUM_MINUTE_TABLES_TO_KEEP_KEY = "smart.access.count.minute.tables.num";
    ...
    public static final String SMART_NUM_SECOND_TABLES_TO_KEEP_KEY = "smart.access.count.second.tables.num";
    public static final int SMART_NUM_SECOND_TABLES_TO_KEEP_DEFAULT = 30;

    public static final String SMART_ACCESS_EVENT_FETCH_INTERVAL_MS_KEY = "smart.access.event.fetch.interval.ms";
    public static final long SMART_ACCESS_EVENT_FETCH_INTERVAL_MS_DEFAULT = 1000L;

    public static final String SMART_CACHED_FILE_FETCH_INTERVAL_MS_KEY = "smart.cached.file.fetch.interval.ms";
    public static final long SMART_CACHED_FILE_FETCH_INTERVAL_MS_DEFAULT = 5 * 1000L;

    public static final String SMART_NAMESPACE_FETCH_INTERVAL_MS_KEY = "smart.namespace.fetch.interval.ms";
    ...
    public static final String SMART_DISPATCH_CMDLETS_EXTRA_NUM_KEY = "smart.dispatch.cmdlets.extra.num";
    ...
    public static final String SMART_SYNC_FILE_EQUALITY_STRATEGY = "smart.sync.file.equality.strategy";
    public static final String SMART_SYNC_FILE_EQUALITY_STRATEGY_DEFAULT = "CHECKSUM";

    // Cmdlets
    public static final String SMART_CMDLET_MAX_NUM_PENDING_KEY = "smart.cmdlet.max.num.pending";
    public static final int SMART_CMDLET_MAX_NUM_PENDING_DEFAULT = 20000;
    public static final String SMART_CMDLET_HIST_MAX_NUM_RECORDS_KEY = "smart.cmdlet.hist.max.num.records";
    public static final int SMART_CMDLET_HIST_MAX_NUM_RECORDS_DEFAULT = 100000;
    public static final String SMART_CMDLET_HIST_MAX_RECORD_LIFETIME_KEY = "smart.cmdlet.hist.max.record.lifetime";
    public static final String SMART_CMDLET_HIST_MAX_RECORD_LIFETIME_DEFAULT = "30day";
    public static final String SMART_CMDLET_CACHE_BATCH = "smart.cmdlet.cache.batch";
    public static final int SMART_CMDLET_CACHE_BATCH_DEFAULT = 600;
    public static final String SMART_CMDLET_MOVER_MAX_CONCURRENT_BLOCKS_PER_SRV_INST_KEY = "smart.cmdlet.mover.max.concurrent.blocks.per.srv.inst";
    public static final int SMART_CMDLET_MOVER_MAX_CONCURRENT_BLOCKS_PER_SRV_INST_DEFAULT = 0;

    // Schedulers
    public static final String SMART_COPY_SCHEDULER_BASE_SYNC_BATCH = "smart.copy.scheduler.base.sync.batch";
    public static final int SMART_COPY_SCHEDULER_BASE_SYNC_BATCH_DEFAULT = 500;
    public static final String SMART_COPY_SCHEDULER_CHECK_INTERVAL = "smart.copy.scheduler.check.interval";
    public static final int SMART_COPY_SCHEDULER_CHECK_INTERVAL_DEFAULT = 500;
    public static final String SMART_FILE_DIFF_MAX_NUM_RECORDS_KEY = "smart.file.diff.max.num.records";
    public static final int SMART_FILE_DIFF_MAX_NUM_RECORDS_DEFAULT = 10000;

    public static final String SMART_MOVER_SCHEDULER_REPORT_FETCH_INTERVAL_MS_KEY = "smart.mover.scheduler.storage.report.fetch.interval.ms";
    public static final long SMART_MOVER_SCHEDULER_REPORT_FETCH_INTERVAL_MS_DEFAULT = 2 * 60 * 1000;

    public static final String SMART_SMALL_FILE_METASTORE_INSERT_BATCH_SIZE_KEY = "smart.metastore.small-file.insert.batch.size";
    public static final int SMART_SMALL_FILE_METASTORE_INSERT_BATCH_SIZE_DEFAULT = 200;

    // Dispatcher
    public static final String SMART_CMDLET_DISPATCHER_LOG_DISP_RESULT_KEY = "smart.cmdlet.dispatcher.log.disp.result";
    ...
    public static final String SMART_CMDLET_DISPATCHER_LOG_DISP_METRICS_INTERVAL_KEY = "smart.cmdlet.dispatcher.log.disp.metrics.interval"; // in
                                                                                                                                            // ms
    ...
    public static final String SMART_ACTION_LOCAL_EXECUTION_DISABLED_KEY = "smart.action.local.execution.disabled";
    ...
    public static final String SMART_AGENT_MASTER_ASK_TIMEOUT_MS_KEY = "smart.agent.master.ask.timeout.ms";
    public static final long SMART_AGENT_MASTER_ASK_TIMEOUT_MS_DEFAULT = 5000L;

    /**
     * Do NOT configure the following two options manually. They are set by the boot
     * scripts.
     **/
    ...
    // Small File Compact
    public static final String SMART_COMPACT_BATCH_SIZE_KEY = "smart.compact.batch.size";
    public static final int SMART_COMPACT_BATCH_SIZE_DEFAULT = 200;
    public static final String SMART_COMPACT_CONTAINER_FILE_THRESHOLD_MB_KEY = "smart.compact.container.file.threshold.mb";
    public static final long SMART_COMPACT_CONTAINER_FILE_THRESHOLD_MB_DEFAULT = 1024;

    // SmartClient

    // Common
    /**
     * Namespace, access info and other info related to files under these dirs will
     * be ignored.
    ...
    /**
     * Namespace, access info and other info only related to files under these dirs
     * will be tackled.
     * For more than one directories, they should be separated by ",".
     */
    ...
    public static final String SMART_INTERNAL_PATH_TEMPLATES_DEFAULT = ".*/\\..*,.*/__.*,.*_COPYING_.*";

    // Target cluster
    public static final String SMART_STORAGE_INFO_UPDATE_INTERVAL_KEY = "smart.storage.info.update.interval";
    public static final int SMART_STORAGE_INFO_UPDATE_INTERVAL_DEFAULT = 60;
    public static final String SMART_STORAGE_INFO_SAMPLING_INTERVALS_KEY = "smart.storage.info.sampling.intervals";
    public static final String SMART_STORAGE_INFO_SAMPLING_INTERVALS_DEFAULT = "60s,60;1hour,60;1day";
    ...
    public static final String SMART_STATUS_REPORT_PERIOD_MULTIPLIER_KEY = "smart.status.report.period.multiplier";
    ...
    public static final String SMART_CLIENT_CONCURRENT_REPORT_ENABLED = "smart.client.concurrent.report.enabled";
    public static final boolean SMART_CLIENT_CONCURRENT_REPORT_ENABLED_DEFAULT = true;

    public static final String SMART_CLIENT_REPORT_TASKS_TIMEOUT_MS_KEY = "smart.client.report.tasks.timeout.ms";
    public static final long SMART_CLIENT_REPORT_TASKS_TIMEOUT_MS_DEFAULT = 2000;

    public static final String SMART_CLIENT_ACTIVE_SERVER_CACHE_PATH_KEY = "smart.client.active.server.cache.path";
    public static final String SMART_CLIENT_ACTIVE_SERVER_CACHE_PATH_DEFAULT = "/tmp/active_smart_server";
