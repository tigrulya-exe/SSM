...
public class SmartConfKeys {
  ...
  public static final String SMART_PROXY_USER_KEY = "smart.proxy.user";

  public static final String SMART_PROXY_USER_STRATEGY_KEY = "smart.proxy.user.strategy";

  public static final String SMART_PROXY_USERS_CACHE_TTL_KEY = "smart.proxy.users.cache.ttl";
  public static final String SMART_PROXY_USERS_CACHE_TTL_DEFAULT = "2m";
