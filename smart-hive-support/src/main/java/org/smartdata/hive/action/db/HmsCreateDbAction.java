...
@ActionSignature(
    actionId = HmsCreateDbAction.NAME,
    displayName = HmsCreateDbAction.NAME,
    usage = HmsCreateDbAction.DEST + " $dest "
        + HmsCreateDbAction.NAMESERVICE_RENAME + " $src_ns $trg_ns "
        + HmsCreateConstraintAction.EVENT_MESSAGE + " message "
)
public class HmsCreateDbAction extends HmsAction {
  public static final String NAME = "hms-create-db";
