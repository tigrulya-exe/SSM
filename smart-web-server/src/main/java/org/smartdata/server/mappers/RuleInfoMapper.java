...
public interface RuleInfoMapper extends SmartMapper {
  ...
  @Mapping(source = "submissionTimeFrom", target = "fromMillis")
  @Mapping(source = "submissionTimeTo", target = "toMillis")
  TimeInterval toTimeInterval(SubmissionTimeIntervalDto intervalDto);

  @Mapping(source = "lastActivationTimeFrom", target = "fromMillis")
  @Mapping(source = "lastActivationTimeTo", target = "toMillis")
