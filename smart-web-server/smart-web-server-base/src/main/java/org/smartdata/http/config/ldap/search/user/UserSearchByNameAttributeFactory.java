 ...
 */
package org.smartdata.http.config.ldap.search.user;

import org.smartdata.conf.SmartConf;
import org.smartdata.http.config.ldap.search.LdapSearchTemplateFactory;
...
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_USER_NAME_ATTR;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_USER_NAME_ATTR_DEFAULT;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_USER_OBJECT;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_USER_OBJECT_DEFAULT;
import static org.smartdata.http.config.ldap.search.LdapUtils.isClassObject;
import static org.smartdata.http.config.ldap.search.query.LdapQueryDsl.and;
import static org.smartdata.http.config.ldap.search.query.LdapQueryDsl.eq;
