 ...
 */
package org.smartdata.http.config.ldap.search.group;
...
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_GROUP_SEARCH_BASE;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_GROUP_SEARCH_SCOPE;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_GROUP_SEARCH_SCOPE_DEFAULT;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_SEARCH_BASE;
import static org.smartdata.http.config.ConfigKeys.SMART_REST_SERVER_LDAP_SEARCH_BASE_DEFAULT;
import static org.smartdata.http.config.ldap.search.LdapUtils.formatTemplate;
import static org.smartdata.http.config.ldap.search.LdapUtils.getRelativeBaseName;
